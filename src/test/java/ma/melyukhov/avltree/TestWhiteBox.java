...
public class TestWhiteBox {
    ...
    public void testRandomFilling() {
        ...
        assertArrayEquals(treeMap.keySet().toArray(),
                ...
                "Тест на заполнение случайными значениями провалился");
    }
    @Test
    ...
    public void testFillAndDeleteRandom() {
        ...
        assertArrayEquals(treeMap.keySet().toArray(), testTree.keySet().toArray(),
                "Тест на заполнение случайными значениями провалился");
        ...
        for(int i = 0; i < randomValues.size(); i++) {
            ...
            assertArrayEquals(treeMap.keySet().toArray(), testTree.keySet().toArray(),
                    "Тест на удаление случайного ключа: " + randomValues.get(index).toString() + " провалился");
        }
    }
}
